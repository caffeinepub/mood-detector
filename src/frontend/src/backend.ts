...
export class Backend implements backendInterface {
    ...
    async getAllMoods(): Promise<Array<Mood>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllMoods();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getRandomMood(): Promise<Mood> {
        if (this.processError) {
            try {
                const result = await this.actor.getRandomMood();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
